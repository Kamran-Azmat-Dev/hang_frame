...
ActiveRecord::Schema.define(version: 2022_01_26_185638) do
  ...
  create_table "custom_preferences", force: :cascade do |t|
    t.bigint "mount_type_id"
    t.integer "min_value"
    t.integer "max_value"
    t.decimal "default_size", precision: 10, scale: 2
    t.decimal "price", precision: 10, scale: 2, default: "0.0", null: false
    t.index ["mount_type_id"], name: "index_custom_preferences_on_mount_type_id"
  end

  create_table "foil_blocking_colors", force: :cascade do |t|
    t.string "name"
    t.string "display"
  ...
  create_table "hang_photos", force: :cascade do |t|
    t.integer "status"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    ...
    t.string "cropped_photo_file_name"
    t.string "cropped_photo_content_type"
    t.integer "cropped_photo_file_size"
    t.datetime "cropped_photo_updated_at"
    t.integer "width", default: 0, null: false
    t.integer "height", default: 0, null: false
    t.integer "hang_type"
    t.decimal "print_width", precision: 10, scale: 2
    t.decimal "print_height", precision: 10, scale: 2
    t.integer "original_art_type_id"
    t.integer "print_size_option_value_id"
  ...
  create_table "moulding_type_prices", force: :cascade do |t|
  ...
  create_table "moulding_types", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end

  create_table "mount_colors", force: :cascade do |t|
    t.string "name"
    ...
    t.boolean "allow_float_mount", default: false
  end

  create_table "mount_options", force: :cascade do |t|
    t.string "name"
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.string "label"
    t.index ["name"], name: "index_mount_options_on_name"
  end

  create_table "mount_preview_images", force: :cascade do |t|
  ...
  create_table "original_art_types", force: :cascade do |t|
    t.string "name"
    t.boolean "active"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "preview_images", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.decimal "border_width", precision: 10, scale: 2
    t.decimal "border_pattern_repeats", precision: 10, scale: 2
  end

  create_table "print_size_additionals", force: :cascade do |t|
    t.bigint "print_size_id"
    t.bigint "additional_id"
    t.index ["additional_id"], name: "index_print_size_additionals_on_additional_id"
    t.index ["print_size_id"], name: "index_print_size_additionals_on_print_size_id"
  end

  create_table "print_size_mount_options", force: :cascade do |t|
    t.bigint "print_size_id"
    t.bigint "mount_option_id"
    t.index ["mount_option_id"], name: "index_print_size_mount_options_on_mount_option_id"
    t.index ["print_size_id"], name: "index_print_size_mount_options_on_print_size_id"
  end

  create_table "print_size_mount_types", force: :cascade do |t|
    t.bigint "print_size_id"
    t.bigint "mount_type_id"
    t.index ["mount_type_id"], name: "index_print_size_mount_types_on_mount_type_id"
    t.index ["print_size_id"], name: "index_print_size_mount_types_on_print_size_id"
  end

  create_table "print_sizes", force: :cascade do |t|
    t.string "name"
    t.string "label"
    t.integer "longest_side", default: 0, null: false
    t.integer "shortest_side", default: 0, null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "spree_adjustments", id: :serial, force: :cascade do |t|
    ...
    t.string "notes"
    t.decimal "mount_top", precision: 10, scale: 2
    t.decimal "mount_left", precision: 10, scale: 2
    t.decimal "mount_bottom", precision: 10, scale: 2
    t.decimal "mount_right", precision: 10, scale: 2
  ...
  create_table "spree_line_items", id: :serial, force: :cascade do |t|
    ...
    t.integer "hang_photo_id"
    t.integer "print_size_id"
    t.integer "mount_color_id"
    t.integer "accent_mount_color_id"
    t.boolean "foil_blocking", default: false
    t.index ["accent_mount_color_id"], name: "index_spree_line_items_on_accent_mount_color_id"
    t.index ["hang_photo_id"], name: "index_spree_line_items_on_hang_photo_id"
    t.index ["mount_color_id"], name: "index_spree_line_items_on_mount_color_id"
    t.index ["order_id"], name: "index_spree_line_items_on_order_id"
    t.index ["print_size_id"], name: "index_spree_line_items_on_print_size_id"
  ...
  create_table "spree_orders", id: :serial, force: :cascade do |t|
    ...
    t.integer "original_art_packaging"
    t.string "recepient_name"
    t.text "recepient_message"
    t.integer "original_art_delivery"
    t.integer "original_art_delivery_price", default: 10
  ...
  create_table "spree_products", id: :serial, force: :cascade do |t|
    ...
    t.boolean "is_donation", default: false
    t.integer "moulding_type_id"
    t.boolean "allow_float_mount", default: false
    t.boolean "featured"
